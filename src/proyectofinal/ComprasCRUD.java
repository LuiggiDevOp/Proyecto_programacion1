...
public class ComprasCRUD extends JFrame {
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(txtPrecioUnitario, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tablacomprasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablacomprasMouseClicked
        ...
        bntagregarcompra.setEnabled(false);
        ...
        this.txtIdProducto.setText(this.tablacompras.getValueAt(fila, 2).toString());
        this.txtNombreProducto.setText(this.tablacompras.getValueAt(fila, 3).toString());
        this.txtCantidad.setText(this.tablacompras.getValueAt(fila, 4).toString());
        this.txtStock.setText(this.tablacompras.getValueAt(fila, 5).toString());
        this.txtidcliente.setText(this.tablacompras.getValueAt(fila, 6).toString());
        this.txtPrecioUnitario.setText(this.tablacompras.getValueAt(fila, 7).toString());
        this.txtTotal.setText(this.tablacompras.getValueAt(fila, 8).toString());
