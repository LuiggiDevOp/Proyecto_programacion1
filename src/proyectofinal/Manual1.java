 ...
 * @author Gamers
 */
public class Manual1 extends javax.swing.JFrame {

    /**
     * Creates new form Manual1
     */
    public Manual1() {
        initComponents();
    }
    ...
    private void Man(){
        ManualPrincipalaejecutar Mn = new  ManualPrincipalaejecutar();
        Mn.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Manual1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
