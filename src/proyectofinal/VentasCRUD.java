...
import proyectofinal.Proveedor;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("System Max Invent");
    ...
    private void actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_actualizarActionPerformed
        ...
        try {
           PreparedStatement ps=cn.prepareStatement("UPDATE ventas SET " +
                    ...
                    "Apellido_Cliente='" + txtApellido.getText() + "', " +
    ...
    private void mostrardatosClientes(){
       ...
       private void mostrardatosVentas(){
           ...
           modeloventas.addColumn("id ventas");
           ...
           modeloventas.addColumn("Nombre cliente");
           modeloventas.addColumn("Apellido cliente");
